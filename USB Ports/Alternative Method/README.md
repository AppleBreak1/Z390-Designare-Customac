Alternative to using OEM GUPC and TUPC method is to create new method to take two arguments and to be used in Mac OS only. We can name the new method whatever we want. (AUPC, ZUPC, XUPC, MUPC, etc)
